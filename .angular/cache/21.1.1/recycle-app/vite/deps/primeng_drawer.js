...
import {
  ...
  isPlatformBrowser,
  isPlatformServer
} from "./chunk-WLJCUUBK.js";
import "./chunk-FXXIW5PT.js";
import {
...
var DomHandler = class _DomHandler {
  ...
  static getViewport() {
    let win = window, d = document, e = d.documentElement, g2 = d.getElementsByTagName("body")[0], w3 = win.innerWidth || e.clientWidth || g2.clientWidth, h = win.innerHeight || e.clientHeight || g2.clientHeight;
    return { width: w3, height: h };
  }
  static getOffset(el) {
...
function A(t, n) {
  ...
  }, [m2, i] = o(v2), [M, f2] = o(E), r = Math.max(...i.map((l2, c2) => l2 + m2[c2])), u = Math.max(...f2.map((l2, c2) => l2 + M[c2])), a2, s3 = 0, d = 0;
  return n === v2 ? r > 0 && (a2 = v2, s3 = r, d = i.length) : n === E ? u > 0 && (a2 = E, s3 = u, d = f2.length) : (s3 = Math.max(r, u), a2 = s3 > 0 ? r > u ? v2 : E : void 0, d = a2 ? a2 === v2 ? i.length : f2.length : 0), { type: a2, timeout: s3, count: d };
}
function $(t, n) {
...
function tt(t, n) {
  ...
  let e = {}, o = false, m2 = {}, i = null, M = {}, f2 = (a2) => {
    if (Object.assign(e, k2(a2, U2)), !e.enter && !e.leave) throw new Error("Enter or leave must be true.");
...
var Drawer = class _Drawer extends BaseComponent {
  ...
  enableModality() {
    ...
    if (!this.mask) {
      ...
      if (this.mask) {
        const style9 = `z-index: ${zIndex};${this.getMaskStyle()}`;
        _t(this.mask, "style", style9);
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    contentQueries: function Drawer_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        ɵɵcontentQuery(dirIndex, _c058, 4)(dirIndex, _c12, 4)(dirIndex, _c22, 4)(dirIndex, _c32, 4)(dirIndex, _c42, 4)(dirIndex, PrimeTemplate, 4);
      }
      if (rf & 2) {
        let _t2;
